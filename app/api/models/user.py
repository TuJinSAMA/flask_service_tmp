...
class UserModel(db.Model):
    ...
    # 用户名
    username = db.Column(db.String(40), nullable=False, comment='用户姓名')
    # 密码
    pwd = db.Column(db.String(102), nullable=False, comment='密码')
    # salt
    salt = db.Column(db.String(32), nullable=False, comment='salt')
    # 创建时间
